...
ALTER TABLE "closing_details" ADD FOREIGN KEY ("closing_id") REFERENCES "closing" ("id");

ALTER TABLE "closing_details" ADD FOREIGN KEY ("payment_method_id") REFERENCES "payment_method" ("id");
